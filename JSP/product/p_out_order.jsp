...
%>
    ...
    <body class="sb-nav-fixed">
        ...
        <div class="row">            
            <div class="col-xl-6" style="width : 100%;">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="p_out_process.jsp" method="post">
                        <table class ="inputTable" style ="width:100%;">
                            ...
                            <tbody>
                            <tr>
                            <td><input disabled type="text" id ="p_barcode" name = "p_barcode"   value="barcode" required /></td>
                            <td><input disabled type="text"  id = "p_code" name = "p_code" value="code" required></input></td>
                            <td><input disabled type="text" id ="p_class" name = "p_class"   value="class" required ></input></td>
                            <td><input disabled type="text"  id = "p_name" name = "p_name" value="name" required></input></td>
                            <td><input type="number" id ="p_count" name = "p_count"   value="0" min ="0" max="999999" required ></input></td>
                            <td><input disabled type="text"  id = "p_size" name = "p_size" value="size" required></input></td>
                            <td><input disabled type="text" id ="p_price" name = "p_price"   value="price" required ></input></td>
                            <td><input disabled type="text"  id = "p_locate" name = "p_locate" value="locate" required></input></td>
     ...
     <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
        ...
        <script src="../js/datatable/p_out_order.js"></script>
