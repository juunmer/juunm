      ...
      <fieldset>
        ...
        <br><br>  
          <label for="count" ></label>재고 : </label>
            <input type="text" name="count" id="count" placeholder="수량 입력"  size = 12px;>

        <br><br>  
        <label for="Dept " ></label>담당부서(차후 수정) : </label>
            <input type="text" name="Dept " id="Dept " placeholder="입력불가" readonly size = 12px;>
