...
<head>
  ...
  <link rel="stylesheet" href="../stock/css/factorystyle.css">
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.2/dist/js/bootstrap.bundle.min.js"></script>
  <script src="https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <script src="../stock/jquery-3.6.0.min.js"></script>
  <%
  // 현재 페이지를 받아옴 
...
try {
  ...
  //자재 삭제확인 함수.. include로 하면 한글이 깨진다ㅠㅠ
...
<body>
  <!-- 상단,사이드 메뉴바 불러오기-->
   ...
   <!--제목-->
   &emsp;<a class="text" href="../stock/bom.jsp" style="color:rgb(0, 0, 0); font-size: 30px; text-decoration-line: none;"><b>자재 관리(DB수정으로 추가/삭제/조회불가)</b></a>
  
  <!--조회 폼 // 조건을 check()로 확인 후 submit-->
   <nav class="navbar navbar-expand-md" style="margin: 10; padding: 0; background-color:lightgray">
    <form method ="post" name="find" action="../stock/bom.jsp" onsubmit="return findcheck()" >
      ...
      &emsp; &emsp;<label for="Mname" ></label>조회 날짜: </label>
        ...
        <select name="category" style="width:110px">
          ...
          <option value="Pd">일반 제품</option>
          <option value="OutPd">외주 제품</option>
          <option value="Part">부품</option>
          <option value="Sup">비품</option>
...
<script src="../stock/js/bootstrap.js"></script>
