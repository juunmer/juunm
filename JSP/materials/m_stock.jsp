            ...
            <div id="layoutSidenav_content">
              <main>
                  <div class="container-fluid px-4">
                      <h1 class="mt-4">자재 재고관리</h1>
                      <ol class="breadcrumb mb-4">
                          <li class="breadcrumb-item"><a href="../index.jsp">Main</a></li>
                          <li class="breadcrumb-item active">자재 재고관리</li>
                      </ol>
                ...
                <table id="myTable" class="display" style="width:100%;">
                        <!-- 입고 출고 명령 -->
                        <button class="btns" onclick = "m_in_order(); return false;">입고</button> 
                        <button class="btns" onclick = "m_out_order(); return false;">출고</button>
                        <button class="btns" onclick = "m_input(); return false;">자재등록</button>
                    <thead>
                        <tr>
                            <th>바코드</th>
                            <th>상품코드</th>
