...
<%
    ...
    ResultSet rs;
    String sql = "select date_format(inputDate,'%Y-%m-%d') as date , sum(eq_a) eq_a,sum(eq_b) eq_b,sum(eq_c) eq_c,sum(eq_d) eq_d,sum(eq_e) eq_e,sum(eq_a+eq_b+eq_c+eq_d+eq_e) sum_eq from elc_eq group by date;";
