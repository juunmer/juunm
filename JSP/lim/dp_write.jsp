...
<div id='page-wrapper'>
    ...
    <div class='row'><div class='col-lg-12'><ol class='breadcrumb'><li><a href="../index.jsp">홈</a></li><b>&ensp;/&ensp;</b><li class='active'>부서설정관리</li></ol></div></div>
        ...
        <form name='form' method='post'action='dp_writeAction.jsp' action="return check(this)">

          <div class='col-lg-12 text-center'><span class='st'>*</span><label>부서코드</label></div>
            <div class='col-lg-12 text-center'>
              <input type='text' name="dpcode" maxlength='10' size='10' style='background-color:#FFE2D5;'>
              <p class='help-block'></p>
            </div>

            <div class='col-lg-12 text-center'><span class='st'>*</span><label>부서이름</label></div>
            <div class='col-lg-12 text-center'>
              <input type='text' name="dpname" maxlength='10' size='10' style='background-color:#FFE2D5;' placeholder="부서이름">
              <p class='help-block'></p>
            </div>
