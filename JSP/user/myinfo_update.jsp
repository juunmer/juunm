...
<div id="layoutSidenav_content">
  ...
  <div id="container">
    <div class="loginArea">
      <form method="post" action="myinfo_update_process.jsp" >
      <table class="type09">
      
      <tbody>
      
      <tr>
          <th scope="row">INFO > 나의정보 > 수정</th>
...
%>
      ...
      <table style="margin-left: auto; margin-right: auto;">
        <tr>
          <br>
          <div>
          <td style="text-align: center;"><input type="button" class="button button1"value="뒤로가기" onclick="location.href='../index.jsp'"></td></center>
          <td style="text-align: center;"><input type="submit" class="button button2" value="수정" onclick="location.href='myinfo_update_process.jsp'"></td>         
          </div>
        </tr>
      </table>
